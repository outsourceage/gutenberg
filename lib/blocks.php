...
if ( ! function_exists( 'gutenberg_parse_blocks' ) ) {
	 ...
	 *
	 * @since 0.5.0
	 * @deprecated 4.9.0 parse_blocks()
	 *
	 * @param  string $content Post content.
	 * @return array  Array of parsed block objects.
	 */
	function gutenberg_parse_blocks( $content ) {
		_deprecated_function( __FUNCTION__, '4.9.0', 'parse_blocks()' );
 ...
 * @deprecated 4.9.0 render_block()
 *
 * @param  array $block A single parsed block object.
 * @return string String of rendered HTML.
 */
function gutenberg_render_block( $block ) {
	_deprecated_function( __FUNCTION__, '4.9.0', 'render_block()' );
